...
export default function Footer() {
  return (
    <footer className="bg-[#050505] text-white mt-12 sm:mt-16">

      {/* TOP LINE */}
      <div className="w-full h-[1px] bg-white/10" />

      {/* CONTENT */}
      <div className="w-full max-w-6xl mx-auto px-4 sm:px-6 md:px-10 py-10 md:py-14 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
      ...
      {/* BOTTOM */}
      <div className="border-t border-white/10 text-center py-3 text-xs sm:text-sm text-gray-500">
